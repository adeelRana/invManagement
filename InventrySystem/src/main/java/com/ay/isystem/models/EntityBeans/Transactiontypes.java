...
@NamedQueries({
    ...
    @NamedQuery(name = "Transactiontypes.findByTranTitle", query = "SELECT t FROM Transactiontypes t WHERE t.tranTitle = :tranTitle")})
public class Transactiontypes implements Serializable {
    ...
    public Transactiontypes(Integer id) {
        this.id = id;
    }

    public Transactiontypes(Integer id, String tranTitle) {
        this.id = id;
    ...
    public String toString() {
        return "com.inventrysystem.models.Transactiontypes[ id=" + id + " ]";
    }
